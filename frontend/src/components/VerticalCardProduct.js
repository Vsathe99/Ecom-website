  ...
  return (
   ...
   {   loading ? (
    ...
    data.map((product,index)=>{
        return(
            <Link to={"product/"+product?._id} className='w-full  min-w-[280px] md:min-w-[350px] max-w-[280px] md:max-w-[320px]  bg-white rounded-sm shadow '>
